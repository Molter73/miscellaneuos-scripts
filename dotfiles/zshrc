...
plugins=(git command-not-found docker gcloud kubectl vagrant rust ansible minikube)
...
export PATH="$PATH:/Users/mmoltras/.crc/bin/oc"

# k3s cluster
export KUBECONFIG="/Users/mmoltras/.kube/k3s.yaml"
export KUBE_EDITOR="nvim"

# Python binaries
export PATH="$PATH:/Users/mmoltras/Library/Python/3.9/bin/"

autoload -U compinit; compinit

# Script kiddie dir
export PATH="$PATH:/Users/mmoltras/bin"
